const Data =[
    {
      ...
      "Title": "Star Trek",
      "Description": "Aboard the USS Enterprise, the most-sophisticated starship ever built.",
      "ImageURL": "https://i.pinimg.com/originals/82/8b/b3/828bb3783453b22bb9f8ff59a77658da.jpg",
      "TrailerURL": "https://www.youtube.com/embed/pKFUZ10Wmbw",
      "Featured": false,
      "Release": "2009",
      "Rating": 2
    },
    {
      ...
      "Title": "The Avengers",
      "Description": "When Thor's evil brother, Loki (Tom Hiddleston).",
    ...
    },
    {
      ...
      "Title": "Stardust",
      "Description": "To win the heart of his beloved (Sienna Miller), a young man named Tristan (Charlie Cox) ventures into the realm of fairies to retrieve a fallen star.",
      "ImageURL": "https://images-na.ssl-images-amazon.com/images/I/5100B4U4ylL._AC_.jpg",
      "TrailerURL":"https://www.youtube.com/embed/-wwv427DAvA",
      "Featured": true,
      "Release": "2007",
      "Rating": 2.5
    },
    {
      ...
      "Description": "In the early 1960s, during the height of the Cold War ",
      ...
      "TrailerURL": "https://www.youtube.com/embed/kyQKi5-k0UU",
      "Featured": false,
      "Release": "2011",
      "Rating": 3.5
    },
    ...
    },
    {
      ...
      "Description": "Harry Potter's (Daniel Radcliffe) third year at Hogwarts starts off badly when he learns deranged killer Sirius Black (Gary Oldman) has escaped from Azkaban prison and is bent on murdering the teenage wizard.",
    ...
    },
    {
      ...
      "Description": "The culmination of nearly 10 years of work and conclusion to Peter Jackson's epic trilogy",
    ...
    },
    {
      ...
      "Title": "Iron Man",
      "Description": "A billionaire industrialist and genius inventor, Tony Stark (Robert Downey Jr.).",
    ...
    },
    {
      ...
      "Title": "Jurassic Park",
      "Description": "Paleontologists Alan Grant (Sam Neill) and Ellie Sattler (Laura Dern) and mathematician Ian Malcolm (Jeff Goldblum) are among a select group chosen to tour an island theme park populated by dinosaurs .",
